...
int main() {
    ...
    // DEM enabled: halve every two levels, floor at max(demMeshN-1, 4).
    ...
    assert(AdaptiveMeshSegments(8, 64, 5, true) == 4);
    assert(AdaptiveMeshSegments(9, 64, 5, true) == 4);
    ...
    assert(AdaptiveMeshSegments(7, 12, 5, true) == 4);
